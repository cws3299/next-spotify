...
export function Sidebar() {
    return (
        <div className="hidden sm:flex flex-col w-[331px] h-full">
            <div className=" text-white rounded-lg w-full h-full p-2 mb-2 mr-2 ">
                <ul className="list-none p-0 m-0">
                    <li>
                        <Link href="/" passHref>
                            <div className="flex items-center gap-5 pb-2 text-sm font-semibold hover:text-[#1da1f2]  text-white hover:cursor-pointer">
